...
public class JedisPoolUtil {
    ...
    protected JedisPoolUtil(String propertyPath) {
...
//            lock.unlock();
//        }
////        propertyPath = "readConfig.properties";
//        return instance;
//    }
     ...
     * 初始化JedisPool
     */
    private void initJedisPool(String propertyPath) {
        properties = ConfigHelper.loadProperties(propertyPath);
...
//        sentinels.add("127.0.0.1:26381");
    ...
    private Jedis getJedis(String configPath) {
        if (jedisPool == null) {
            lock.lock();
            initJedisPool(configPath);
            lock.unlock();
