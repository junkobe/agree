...
public class JedisReadPoolUtil {
...
//    private String propertyPath = "";
    ...
    private static JedisReadPoolUtil instance = null;
    private static ReentrantLock lock = new ReentrantLock();

    private JedisReadPoolUtil(){

    }

    public static JedisReadPoolUtil getInstance(){
        if(instance==null){
            lock.lock();
            if(instance==null){
                instance = new JedisReadPoolUtil();
            }
            lock.unlock();
        }
        return instance;
    ...
    private void initJedisPool() {
        properties = ConfigHelper.loadProperties("readConfig.properties");
...
//    }
    ...
    public class Scan{
        ...
        public ScanResult<String> scan(String cursor, String match,int count){
            Jedis jedis = getJedis();
